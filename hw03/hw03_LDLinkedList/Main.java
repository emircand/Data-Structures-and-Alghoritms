...
/**
 * Driver method for LinkedList implementation 
 */
public class Main {
	...
	public static void main(String[] args) {
        ...
        StreetLDL mainStreet = new StreetLDL(30);
        ...
        for (var element : mainStreet.getStreetLDL()) {
            element.Focusing();
        }
        ...
        StreetLDL mainStreet = new StreetLDL(inputInt);
            ...
            switch (inputStr) {
                ...
                case "2":
                    ...
                    switch (inputStr) {
                        ...
                        case "6":
                            System.out.println("--------------------");
                            for(var i: mainStreet.getStreetLDL())
                                i.Focusing();
                            break;
                        default:
                            System.err.println("invalid input returning to menu..");
