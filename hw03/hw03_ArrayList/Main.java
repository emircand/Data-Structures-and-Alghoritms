...
/**
 * Driver method for ArrayList implementation 
 */
...
public class Main {
	public static void main(String[] args) {
        ...
        StreetArrayList mainStreet = new StreetArrayList(30);
        ...
        for (var element : mainStreet.getStreetAL()) {
            element.Focusing();
        }
        /*
        ...
        StreetArrayList mainStreet = new StreetArrayList(inputInt);
            ...
            switch (inputStr) {
                ...
                case "2":
                    ...
                    switch (inputStr) {
                        ...
                        case "6":
                            System.out.println("--------------------");
                            for(var i: mainStreet.getStreetAL())
                                i.Focusing();
                            break;
                        default:
                            System.err.println("invalid input returning to menu..");
